...
export class ModelsProvider {
    ...
    async fetchModels() {
        ...
        try {
            ...
            this.models = modelList.map(m => new ModelItem(`${m.name} (${m.id})`, vscode.TreeItemCollapsibleState.None, m.engine === 'deepseek'
                ? new vscode.ThemeIcon('symbol-class')
                : new vscode.ThemeIcon('symbol-color'), { engine: m.engine, id: m.id }));
            return this.models;
        }
        catch (err) {
