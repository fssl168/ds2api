...
export function activate(context) {
    ...
    context.subscriptions.push(vscode.window.registerTreeDataProvider('ds2api-mcp.models', modelsProvider), vscode.commands.registerCommand('ds2api-mcp.showStatus', async () => {
