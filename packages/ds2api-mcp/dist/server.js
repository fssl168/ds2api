...
function createServer(options) {
    ...
    server.tool("chat", `Send a chat completion request to ds2api.
...
Returns the model's response text.`, {
    ...
    server.tool("list_models", "List all available models supported by ds2api, including DeepSeek and Qwen models.", {}, async () => {
        try {
    ...
    server.tool("get_status", "Get ds2api service status including health check and account pool information.", {}, async () => {
        try {
    ...
    server.tool("get_pool_status", "Get detailed account pool status for both DeepSeek and Qwen pools.", {
    ...
    server.tool("embeddings", "Generate embeddings for text using ds2api.", {
